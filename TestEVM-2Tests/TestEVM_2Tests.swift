...
//        }
        ...
        let proof = COAOwnershipProof(keyIninces: [0], address: address.data, capabilityPath: "/public/evm", signatures: [sig])
...
//        print("orginal message ===> \(text)")
        ...
        let read = contract.createReadOperation("isValidSignature", parameters: [hashed2, encoded])!
...
//        print("verfy ==> \(verfy)")
        ...
        XCTAssertEqual(data, Data(hex: magicValue))
    }
}
